...
function Header() {
  return (
    <header className="relative text-white py-4 px-8 flex items-center justify-between burger ero-pattern">
      <div className="flex items-center space-x-4">
        <button className="bg-green-500 text-white font-bold px-4 py-2 rounded-sm text-lg ">STREET88</button>
      </div>
      <nav className="flex items-center space-x-8 text-green-500 text-lg font-medium">
...
function HeroSection() {
  return (
    <section className="relative bg-cover bg-center text-white py-20 px-16">
      <div className="max-w-2xl ml-16">
        <h1 className="text-6xl font-extrabold text-green-500">БОЛЬШОЙ ГАМБУРГЕР</h1>
